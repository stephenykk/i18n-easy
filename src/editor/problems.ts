...
export const PROBLEM_CODE_HARD_STRING = 'i18n-easy-hard-string'
export const PROBLEM_KEY_MISSING = 'i18n-easy-key-missing'
export const PROBLEM_TRANSLATION_MISSING = 'i18n-easy-translation-missing'
